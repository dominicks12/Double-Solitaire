...
class Board:
    ...
    def start():
        ...
        # Buttons
        start_button = pygame.Rect(275, 250, 150, 25)
        instruct_button = pygame.Rect(275, 290, 150, 25)
        exit_button = pygame.Rect(275, 330, 150, 25)
    ...
    def waiting_screen():
        ...
        #Button
        back_button = pygame.Rect(275, 250, 150, 25)
    ...
    @staticmethod
    def display_card(card, x_pos, y_pos):
        card_suit = card.get_suit_name()
        card_value = card.get_rank_value()

        card_name = card_value + "_of_" + card_suit
        card_image = pygame.image.load(card_name)

        Board.screen.blit(card_image, (x_pos,y_pos))

    @staticmethod
    def display_stack(card_stack, num_stack):
        #num_stack will let us know where to start
        #displaying the stack (first card pos)